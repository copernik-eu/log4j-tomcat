...
/**
 * <p>
 * A classloader that delegates lookups for Log4j2 API classes to the parent
 * classloader.
 * </p>
 * <p>
 * This allows multiple applications bundled with Log4j2 API to use a single
 * copy of Log4j2 in the parent classloader, without modifying the servlet
 * delegation model for the application.
 * </p>
 * 
 * <p>
 ...
 * </pre>
 * <p>
 * to the application's context definition (cf. <a href=
 * "https://tomcat.apache.org/tomcat-10.0-doc/config/context.html#Defining_a_context">defining
 * a context</a>).
 */
